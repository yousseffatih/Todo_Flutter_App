        ...
        child: SingleChildScrollView(
          child: Column(
            children: [
              ...
              InputField(title: "Title", hint: "Enter yout title",controller: _titleController,),
              InputField(title: "Note", hint: "Enter yout Note",controller: _noteController,),
              InputField(
                title: "Date", 
                ...
                widget: Row(
                  children: [
                    DropdownButton(
                      ...
                      style: subTitlestyle,
                      items: remaindList.map((value) => DropdownMenuItem(
                ...
                widget: Row(
                  children: [
                    DropdownButton(
                      ...
                      style: subTitlestyle,
                      items: repateList.map((value) => DropdownMenuItem(
                ...
                children: List.generate(3, (index) {
                  return GestureDetector(
                    ...
                    child: Padding(
                        ...
                        child: CircleAvatar(
                          child: selectedColor == index? const Icon(Icons.done,color: Colors.white,size: 16,) : null,
