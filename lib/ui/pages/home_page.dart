...
class _HomePageState extends State<HomePage> { 
          ...
          child: RefreshIndicator(
            ...
            child: SingleChildScrollView(
              child: Wrap(
                ...
                children: [
                  SizeConfig.orientation == Orientation.landscape? const SizedBox(height: 6,):const SizedBox(height: 230,),
                  SvgPicture.asset(
                    "images/task.svg",
                  ...
                  SizeConfig.orientation == Orientation.landscape? const SizedBox(height: 160,):const SizedBox(height: 160,),
                ],
              ),
            ),
          ),
      ...
      SingleChildScrollView(
        child: Container(
          ...
          height: (SizeConfig.orientation == Orientation.landscape)?
                    ...
                    :(task.isCompleted == 1 ?
                       SizeConfig.screenHeight * 0.30 : SizeConfig.screenHeight * 0.39),
  ...
  _buildbottemSheet({required String label, required Function() onTap,required Color clr, bool isClose = false}){
